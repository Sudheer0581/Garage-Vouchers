    ...
    <>
      <tr>
        ...
        <td style={{ borderBottom: '1px solid #ddd',  padding: '10px 8px', textAlign: 'left' }}>
          {props.person === '1' ? (
            <>
              <button className="btn btn-primary" onClick={handleForward} style={{marginRight:'5px'}}>Forward to ACAO</button>
            ...
            <>
            <p style={{display:'inline-block',marginRight:'8px'}}>Forwaded to ACAO</p>
...
export default OfficialVoucher
...
{/* <div>
      <tr key={props.id}>
                    ...
                    <td>{props.remarks}</td>
                    <td>
                        {props.person==='1'?<button className="btn btn-primary" onClick={handleForward}>Forward to ACAO</button>:<></>}
                    </td>
                </tr>
                <ToastContainer />
    </div> */}