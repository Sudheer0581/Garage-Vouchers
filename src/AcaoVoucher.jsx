...
<>
      <tr>
        ...
        <td style={{ borderBottom: '1px solid #ddd',  padding: '10px 8px', textAlign: 'left' }}>
          {props.person === '2' ? (
            <>
              <button className="btn btn-primary" onClick={handleForward} style={{marginRight:'6px'}}>Forward to VC</button>
            ...
            <>
            <p style={{display:'inline-block',marginRight:'7px'}}>Forwarded to VC</p>
